...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-2ggs8@^tuofdpir3fi&s2&&tc749mlnsgpa4-t68bo*3a6t_j2')
...
CORS_ALLOWED_ORIGINS = [
    f'http://localhost:{os.environ.get("FRONT_PORT", 3000)}',
]
...
LOGGING = {
    ...
    'loggers': {
        'challenge': {'level': 'DEBUG', 'handles': ['console']}
    },
}
